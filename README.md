...
고객과 소통하면서 원하는 바가 무엇인지 캐치를 해서 구현하는 게 중요하다고 느꼇고, 프로젝트 기간내 개발을 완성하기 위해서 개발자의 생산성이 얼마나 중요한지 알게 되었다.
그리고 포기만 안하면 뭐든 다 할수 있다고 느끼게 되는 계기가 되었고, 개발자는 평생 배우며 살아가야 한다는 그 사실이 가슴을 뛰게 한다.
항상 노력하고 잘하는 개발자가 되야겠다.